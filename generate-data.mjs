...
writeFileSync("./data/cohortDataProcessed.json", JSON.stringify(processed, null, 2));
console.log(`Done — ${processed.length} records written to data/cohortDataProcessed.json`);