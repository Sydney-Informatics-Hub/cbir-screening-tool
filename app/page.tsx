          ...
          <div className="space-y-4 w-full min-w-0">
            <table className="w-full border-collapse">
              <thead>
                ...
                >
                  <th className="text-left py-2 px-2 font-semibold text-xs w-10">
                    Q#
                  </th>
                  <th className="text-left py-2 px-2 font-semibold text-xs w-15">
                    Item
                  </th>
                  <th className="text-center py-2 px-2 font-semibold text-xs w-12">
                    Score
                  </th>
                  <th className="text-center py-2 px-2 font-semibold text-xs w-12">
                    Threshold
                  </th>
                  <th className="text-center py-2 px-2 font-semibold text-xs w-14">
                    Summary
                  </th>
                </tr>
              </thead>
                ...
                {category.items.map((item, itemIndex) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2 px-2 text-center border-b border-slate-200 bg-blue-50">
